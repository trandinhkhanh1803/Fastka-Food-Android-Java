...
function getplayerrow(player) {
    ...
    if (player) {
        ...
        <td class="align-middle">${player.id}</td>
            ...
            <td class="align-middle">${player.title}</td>
            <td class="align-middle">${player.description}</td>
            <td class="align-middle">${player.price}</td>
            <td class="align-middle">${player.rating}</td>
            <td class="align-middle">${player.timeDelivery}</td>
    ...
    $(document).on("click", "a.edituser", function() {
        ...
        $.ajax({
            ...
            success: function(player) {
                if (player) {
                    $("#title").val(player.title);
                    $("#description").val(player.description);
                    $("#price").val(player.price);
                    $("#rating").val(player.rating);
                    $("#timeDelivery").val(player.timeDelivery);
            ...
            success: function(player) {
                if (player) {
                  ...
                  <div class="col-sm-6 col-md-8">
                    ...
                    <i class="fa fa-envelope-o" aria-hidden="true"></i> ${player.title}
                      <br />
                      <i class="fa fa-envelope-o" aria-hidden="true"></i> ${player.description}
                      <br />
                      <i class="fa fa-phone" aria-hidden="true"></i> ${player.price}
                      <br />
                      <i class="fa fa-phone" aria-hidden="true"></i> ${player.rating}
                      <br />
                      <i class="fa fa-phone" aria-hidden="true"></i> ${player.timeDelivery}
                    </p>
                  </div>
                </div>`;
